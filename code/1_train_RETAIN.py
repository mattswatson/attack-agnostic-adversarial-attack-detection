...
parser.add_argument('--new', help='Use new RETAIN model', action='store_true')
...
def main(argv):
	...
	if not args.new:
		...
		from retain_different_embedding import RETAIN, retain_epoch
	...
	for ei in trange(args.epochs, desc="Epochs"):
		...
		plotter.plot('loss', 'train', 'Class Loss', ei, train_loss)

		# Eval
		_, _, valid_loss = retain_epoch(valid_loader, model, criterion=criterion)
		valid_losses.append(valid_loss)

		plotter.plot('loss', 'val', 'Class Loss', ei, valid_loss)
